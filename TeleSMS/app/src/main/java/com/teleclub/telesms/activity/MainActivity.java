...
import com.teleclub.telesms.adapter.TabPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void saveToken() {
        ...
        RetrofitBuilder.createRetrofitService(RajaTalkAPI.class).saveToken(AppData.account.getPhone(), "android", Util.getUniqueIMEI(getApplicationContext()), pushToken, "1")
