package com.teleclub.rabbtel.service;
...
import com.teleclub.rabbtel.util.NotificationUtils;
...
public class RabbtelMessagingService extends FirebaseMessagingService {
    private final String TAG = RabbtelMessagingService.class.getSimpleName();
    ...
    public void onNewToken(String token) {
        SharedPreferences.Editor editor = getApplicationContext().getSharedPreferences(Constants.REBTTEL_PREF, Context.MODE_PRIVATE).edit();
