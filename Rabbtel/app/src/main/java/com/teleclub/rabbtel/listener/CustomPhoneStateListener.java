package com.teleclub.rabbtel.listener;
...
//        Toast.makeText(context, "Called Blocking API", Toast.LENGTH_SHORT).show();
        RetrofitBuilder.createRetrofitService(RabbtelAPI.class).blockAccount(AppData.token, AppData.account.getPhone(),
...
//        Toast.makeText(context, "Called Un-Blocking API", Toast.LENGTH_SHORT).show();
        RetrofitBuilder.createRetrofitService(RabbtelAPI.class).unblockAccount(AppData.token, AppData.account.getPhone(),
                Util.getUniqueIMEI(this.context), "android")
                .subscribeOn(Schedulers.newThread())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new Observer<BlockAccountResult>() {
