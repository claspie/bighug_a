...
import com.teleclub.rajatalk.util.ResourceUtil;
...
//        m_switchIP.setChecked(AppData.useDevIp);
    ...
    private void signIn() {
        ...
        RetrofitBuilder.createRetrofitService(RajaTalkAPI.class).login(m_szPhoneNumber, m_szPassword, Util.getUniqueIMEI(this),
